...
<?php 
	...
	if(ereg("de",$sprache)) { 
		$url="http://eve.guidesworld.de";
		$url2="http://www.game-template.de/";
	}else {
		$url="http://eve.guidezworld.com";
	...
	<div id="container">
		...
		<div id="container2">
			<div id="footer">
				...
				<?php endif; ?>
				<div id="designed_by">
					<p>Design by: <a href="http://www.lernvid.com" target="_blank">LernVid.com</a> feat. <a href="<?php echo $url2 ?>" target="_blank">game-template</a> sponsored by <a href="<?php echo $url ?>" target="_blank">EVE Guide</a></p>
				</div>
			</div>
		</div>
		<div class="clr"></div>
